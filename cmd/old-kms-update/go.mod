module github.com/numeroai/flow-wallet-api/cmd/kms-update
...
require (
	...
	github.com/onflow/flow-core-contracts/lib/go/templates v0.11.1 // indirect
	github.com/onflow/flow-go v0.23.2 // indirect
